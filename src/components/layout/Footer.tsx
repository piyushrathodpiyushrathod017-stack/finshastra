...
const footerSections = {
  resources: {
    ...
    links: [
      ...
      { label: 'Personal Loan Guide', href: '/personal-loan' },
      { label: 'Credit Card Guide', href: '/credit-cards' },
...
const trustBadges = [
  ...
  { icon: RefreshCw, label: 'Updated Content' },
];
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-gray-400">
              Your trusted guide to personal finance in India. Expert-reviewed content on credit
              scores, personal loans, and credit cards. Making financial decisions simpler since
              2026.
            </p>
            ...
            <div className="mt-8 rounded-xl border border-gray-700 bg-gray-800/50 p-4">
              ...
              <p className="mt-1 text-xs text-gray-400">
                Get the latest finance tips and updates delivered to your inbox.
              </p>
              <div className="mt-3 flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="focus:border-primary focus:ring-primary w-full rounded-lg border border-gray-600 bg-gray-700 py-2 pr-3 pl-9 text-sm text-white placeholder-gray-500 focus:ring-1 focus:outline-none"
                  />
                </div>
                <button
                  type="button"
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          ...
          <p className="mt-4 text-center text-xs text-gray-500">
            FinShastra is an informational platform. Content is for educational purposes only and
            does not constitute financial advice. Please consult a certified financial advisor
